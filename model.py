...
class Snapshots(db.Model):
    ...
    previous_snapshot_id = db.Column(db.BigInteger, nullable=True)
...
class Findings(db.Model):
    ...
    finding_id = db.Column(db.BigInteger, primary_key=True)
    snapshot_id = db.Column(db.BigInteger, db.ForeignKey('snapshots.snapshot_id'), nullable=False)
